...
class GauloisController
{
    ...
    public function listGaulois()
    {
        ...
        require 'view/query/gaulois.php';
    }
    ...
    public function requete1()
    {
        ...
        require 'view/query/requete1.php';
    }
    ...
    public function requete2()
    {
        ...
        $requete = $pdo->query('
            ...
            ');
        require 'view/query/requete2.php';
    }
    ...
    public function requete3()
    {
        ...
        $requete = $pdo->query('
            ...
            ');
        require 'view/query/requete3.php';
    }
    ...
    public function requete4()
    {
        ...
        $requete = $pdo->query('
            ...
            ');
        require 'view/query/requete4.php';
    }
    ...
    public function requete5()
    {
        $pdo = Connect::seConnecter();
        $requete = $pdo->query('
            SELECT b.nom_bataille, DATE_FORMAT(b.date_bataille, "%d %M -%y") AS date, l.nom_lieu
            ...
            ');
        require 'view/query/requete5.php';
    }
    ...
    public function requete6()
    {
        ...
        $requete = $pdo->query('
            ...
            ');
        require 'view/query/requete6.php';
    }
    ...
    public function requete7()
    {
        ...
        $requete = $pdo->query('
            ...
            ');
        require 'view/query/requete7.php';
    }
    ...
    public function requete8()
    {
        ...
        $requete = $pdo->query('
            ...
            ');
        require 'view/query/requete8.php';
    }
    ...
    public function requete9()
    {
        ...
        $requete = $pdo->query('
            ...
            ');
        require 'view/query/requete9.php';
    }
    ...
    public function requete10()
    {
        ...
        $requete = $pdo->query('
            ...
            ');
        require 'view/query/requete10.php';
    }
    ...
    public function requete11()
    {
        ...
        $requete = $pdo->query('
            ...
            ');
        require 'view/query/requete11.php';
    }
    ...
    public function requete12()
    {
        ...
        $requete = $pdo->query('
            ...
            ');
        require 'view/query/requete12.php';
    }
    ...
    public function requete13()
    {
        ...
        $requete = $pdo->query('
            ...
            ');
        require 'view/query/requete13.php';
    }
    ...
    public function requete14()
    {
        ...
        $requete = $pdo->query('
            ...
            GROUP BY p.id_personnage
            ');
        require 'view/query/requete14.php';
    }
    ...
    public function requete15()
    {
        ...
        $requete = $pdo->query('
            ...
            ');
        require 'view/query/requete15.php';
    }
}
